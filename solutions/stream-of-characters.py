...
class SolutionTest(unittest.TestCase):
    def test_solution(self):
        self.assertEqual(
            ...
            StreamChecker(["cd", "f", "kl"]).query_all("abcdefghijkl")
        )
        self.assertEqual(
            [True, True, True, True, True, True], 
            StreamChecker(["a", "ab", "bab", "bc", "bca", "c", "caa"]).query_all("abccab")
        )
        self.assertEqual(
            [False,False,True,False,True,False,False,True,False,False,False,False,False,True,False,True,False,False,False,True,False,False,False,False,False,False,False,True,False,True,False,False,False,False,True,False,True,False,True,False],
            StreamChecker(["abaa","abaab","aabbb","bab","ab"]).query_all("aabbbaabbaaaababbbabbbaaaaababbbaabbbaba")
        )
        # aabbbaabbaaaababbbabbbaaaaababbbaabbbaba
        # 00
